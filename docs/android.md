...
For the latest published release (v0.4.1) the direct download is:

<https://github.com/jyshangguan/ArXistant/releases/download/v0.4.1/arxistant-release.v0.4.1.apk>
...
#   -> app/build/outputs/apk/release/arxistant-release.v0.4.1.apk
```
...
- **Phone:** install the release APK
  (`app/build/outputs/apk/release/arxistant-release.v0.4.1.apk`) or the debug APK
